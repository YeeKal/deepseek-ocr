...
export const LOGO_URL =
    "https://cdn.deepseekocr.io/visual-logo/logo-gradient.svg";
export const BRAND_NAME = "Deepseek Ocr";
export const SUPPORT_EMAIL = "yee@deepseekocr.io";

export const GPU_API_URL =
    process.env.GPU_API_BASE_URL || "https://fcebf0e7d6a5.ngrok-free.app";
...
export const DEFAULT_TOOL_COVER_IMAGE =
    "https://cdn.deepseekocr.io/tools/ai-ocr/ai-ocr-cover.webp";

export const SEO_DEFAULT = {
    title: "Free DeepSeek-OCR: High-Accuracy Text & Table Extraction | DeepSeekOCR.io",
    description:
        "Experience DeepSeek-OCR, convert scanned notes, reports, and charts into editable text with incredible accuracy. Free to use, no sign-up required",
    keywords: [
        "deepseekocr",
        "deepseek ocr",
